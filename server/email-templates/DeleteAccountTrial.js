class DeleteAccountTrialTemplate {
  static render(props) {
    return `
            <mjml>
    <mj-head>
    ...
    <mj-body background-color="#f4f4f4">
      <mj-section background-color="#ffffff" padding="20px">
        <mj-column>
          ...
          <mj-text font-size="16px" color="#333333" line-height="24px">
            Vi har noterat att ditt verkstadskonto har raderats från vår plattform. Detta betyder att du inte längre kan ta emot nya förfrågningar eller hantera offerter via FixMatch när provperioden avslutas, vilket är om ${props.days} dagar.
          </mj-text>
...
module.exports = { DeleteAccountTrialTemplate };

...
<template>
  <div class="flex flex-col gap-8 p-4 items-center">
    <div class="flex gap-4 items-center w-full drop-shadow-lg">
    ...
    <form @submit.prevent="handleMessage" class="flex flex-col w-full gap-6">
      <label for="isName" class="font-text-light flex flex-col gap-1 text-start"
        ...
        <TextInput
          ...
          :light="true"
        />
        <p class="text-warning-orange font-text-light flex gap-2 items-center" v-if="showNameError">
          <fontAwesome :icon="['fas', 'triangle-exclamation']" class="text-warning-orange" />Ange
          både för- och efternamn!
        </p>
      </label>

      <label for="isEmail" class="font-text-light flex flex-col gap-1 text-start"
      ...
      <label for="isMessage" class="font-text-light flex flex-col gap-1 text-start"
